...
namespace my_website.Persistance.Context.Migrations
{
    ...
    [Migration("20230713044348_social-media-added-property")]
    partial class socialmediaaddedproperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("my_website.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "24dbe699-cb1c-4584-9400-76b9c07e16a3",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPODdOE8oq/zHKWZJFOCB2a99PPPXsP966G3TQWtjwJNlBHLSWmRHFJtQTqTNeOz1Q==",
            ...
            modelBuilder.Entity("my_website.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 7, 13, 7, 43, 47, 950, DateTimeKind.Local).AddTicks(1338),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("c9f12a78-5e28-497e-9988-6f32415db2ea"),
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
                            CreatedDate = new DateTime(2023, 7, 13, 7, 43, 47, 950, DateTimeKind.Local).AddTicks(1361),
                        ...
                        new
                        {
                            ...
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
                            CreatedDate = new DateTime(2023, 7, 13, 7, 43, 47, 950, DateTimeKind.Local).AddTicks(1367),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("a8639731-02ef-4616-ad38-169b6a170ffb"),
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
                            CreatedDate = new DateTime(2023, 7, 13, 7, 43, 47, 950, DateTimeKind.Local).AddTicks(1373),
